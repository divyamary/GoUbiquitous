...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            JSONObject wearForecast = weatherArray.getJSONObject(0);
            JSONObject wearWeatherObject =
                    wearForecast.getJSONArray(OWM_WEATHER).getJSONObject(0);
            int wearWeatherId = wearWeatherObject.getInt(OWM_WEATHER_ID);
            JSONObject wearTemperatureObject = wearForecast.getJSONObject(OWM_TEMPERATURE);
            double wearHigh = wearTemperatureObject.getDouble(OWM_MAX);
            double wearLow = wearTemperatureObject.getDouble(OWM_MIN);
            sendWearData(wearWeatherId,wearHigh,wearLow);
    ...
    private void sendWearData(int wearWeatherId, double wearHigh, double wearLow) {
        mGoogleApiClient.connect();
        PutDataMapRequest dataMap = PutDataMapRequest.create("/weather");
        dataMap.getDataMap().putInt("weatherId", wearWeatherId);
        dataMap.getDataMap().putDouble("high", wearHigh);
        dataMap.getDataMap().putDouble("low", wearLow);
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, putDataRequest)
                .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                    ...
                    public void onResult(DataApi.DataItemResult dataItemResult) {
                        Log.d(LOG_TAG, "Sending weather data was successful: " + dataItemResult.getStatus()
                                .isSuccess());
                    }
                })  ;
    }
